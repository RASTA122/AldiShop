...
from core.apps.bot.models import Category, SubCategory
...
def get_subcategories(cat_id):
    ...
    for subcategory in subcategories:
        subcategory_markup.add(InlineKeyboardButton(
            text=subcategory.name,
            callback_data=subcategory_cb.new(id=subcategory.id, action='view_subcategories'),
        ))
